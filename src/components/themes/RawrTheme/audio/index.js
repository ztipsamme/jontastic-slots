let audio = {
  src: {
    theme: "./src/components/themes/RawrTheme/audio/theme.mp3",
    btn: "./src/components/themes/RawrTheme/audio/btn.mp3",
    cashIn: "./src/components/themes/Default/audio/cash-in.mp3",
    gameOver: "./src/components/themes/RawrTheme/audio/game-over.mp3",
    invalid: "./src/components/themes/Default/audio/invalid.mp3",
    noWin: "./src/components/themes/RawrTheme/audio/no-win.mp3",
    purchase: "./src/components/themes/Default/audio/purchase.mp3",
    reels: "./src/components/themes/Default/audio/reels.mp3",
    win: "./src/components/themes/RawrTheme/audio/win.mp3",
