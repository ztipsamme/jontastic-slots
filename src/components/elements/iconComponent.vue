...
.brilliant {
  background-image: url("../themes/BrilliantTheme/bg.png");
  background-size: cover;
  background-position: center;
}
.rawr {
  background-image: url(../themes/RawrTheme/bg.png);
  background-size: cover;
  background-position: center;
}
.stadsljus {
  background-image: url(../themes/StadsljusTheme/bg.png);
  background-size: cover;
}
.vildmark {
  background-image: url(../themes/VildmarkTheme/bg.png);
  background-size: cover;
  background-position: center;
}
.inferno {
  background-image: url(../themes/InfernoTheme/bg.jpg);
  background-size: cover;
}
.sjuhaven {
  background-image: url("../themes/SjuhavenTheme/bg.png");
  background-size: cover;
  background-position: center;
}
.bonus {
  ...
  background-color: $secondary;
  img {
    filter: invert(44%) sepia(98%) saturate(371%) hue-rotate(5deg) brightness(99%)
      contrast(95%);
  }
}
.wrapper {
