...
.btn-container {
  ...
  &.purple {
    ...
    & > .btn-comp {
      background-image: linear-gradient(10deg, var(--btn-purple2), var(--btn-purple) 60%);
      &:hover,
      &.selected {
        background-image: linear-gradient(
          10deg,
  ...
  &.blue {
    ...
    & > .btn-comp {
      background-image: linear-gradient(10deg, var(--btn-blue2), var(--btn-blue) 60%);
      &:hover,
      &.selected {
        background-image: linear-gradient(10deg, var(--btn-blue5), var(--btn-blue4) 60%);
  ...
  &.green {
    ...
    & > .btn-comp {
      background-image: linear-gradient(10deg, var(--btn-green2), var(--btn-green) 60%);
      &:hover,
      &.selected {
        background-image: linear-gradient(
          10deg,
  ...
  &.red {
    ...
    & > .btn-comp {
      background-image: linear-gradient(10deg, var(--btn-red2), var(--btn-red) 60%);
      &:hover,
      &.selected {
        background-image: linear-gradient(10deg, var(--btn-red5), var(--btn-red4) 60%);
